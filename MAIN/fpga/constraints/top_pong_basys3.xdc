...
set_property PACKAGE_PIN V13 [get_ports {RxData[0]}]
	set_property IOSTANDARD LVCMOS33 [get_ports {RxData[0]}]
set_property PACKAGE_PIN V3 [get_ports {RxData[1]}]
	set_property IOSTANDARD LVCMOS33 [get_ports {RxData[1]}]
set_property PACKAGE_PIN W3 [get_ports {RxData[2]}]
	set_property IOSTANDARD LVCMOS33 [get_ports {RxData[2]}]
set_property PACKAGE_PIN U3 [get_ports {RxData[3]}]
	set_property IOSTANDARD LVCMOS33 [get_ports {RxData[3]}]
set_property PACKAGE_PIN P3 [get_ports {RxData[4]}]
	set_property IOSTANDARD LVCMOS33 [get_ports {RxData[4]}]
set_property PACKAGE_PIN N3 [get_ports {RxData[5]}]
	set_property IOSTANDARD LVCMOS33 [get_ports {RxData[5]}]
set_property PACKAGE_PIN P1 [get_ports {RxData[6]}]
	set_property IOSTANDARD LVCMOS33 [get_ports {RxData[6]}]
set_property PACKAGE_PIN L1 [get_ports {RxData[7]}]
...
##Sch name = JA7
set_property PACKAGE_PIN H1 [get_ports {echo_second}]
	set_property IOSTANDARD LVCMOS33 [get_ports {echo_second}]
##Sch name = JA8
set_property PACKAGE_PIN K2 [get_ports {trig_second}]
...
##Pmod Header JB
##Sch name = JB1
set_property PACKAGE_PIN A14 [get_ports RxD]
